...
import destinationsData from "../Home/MostVisited/Dataset/Places/bestcitytovisit.json";

function MonthWisePlacesExplore() {
  useEffect(() => {
    ...
    <div>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          {currentItems.map((ciytname, index) => (
...
export default MonthWisePlacesExplore;
